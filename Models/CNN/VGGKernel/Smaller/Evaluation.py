...
model.load_state_dict(torch.load("Models/CNN/VGGKernel/Smaller/VGGKS.pth",map_location = device))
model.eval() 
if __name__ == '__main__':
    ...
    plt.ylabel("Actual")
    # plt.savefig("confusion_matrix_VGGKS.png", dpi=300, bbox_inches='tight')
    plt.show()