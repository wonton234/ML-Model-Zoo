...
model.load_state_dict(torch.load("Models/CNN/VGGNorm/VGGNorm.pth",map_location = device))
model.eval() 
if __name__ == '__main__':
    ...
    plt.title("VGG Normal")
    plt.xlabel("Predicted")
    plt.ylabel("Actual")
    # plt.savefig("confusion_matrix_VGGNorm.png", dpi=300, bbox_inches='tight')
    plt.show()